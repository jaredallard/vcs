...
// Package github implements [fetcher] for Github releases.
package github
...
func (f *Fetcher) createClient(ctx context.Context, token string) *gogithub.Client {
...
func (f *Fetcher) GetReleaseNotes(ctx context.Context, token string, opts *opts.GetReleaseNoteOptions) (string, error) {
...
// release asset.
func (f *Fetcher) Fetch(ctx context.Context, token string, opts *opts.FetchOptions) (io.ReadCloser, os.FileInfo, error) {
	gh := f.createClient(ctx, token)
